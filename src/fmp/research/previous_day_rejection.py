...
PREVIOUS_DAY_REJECTION_GRID = (0, 2, 5)
SLIPPAGE_SCENARIOS = (0.2, 0.5, 1.0)
STARTING_EQUITY_USD = 100_000.0
REQUESTED_RISK_FRACTION = 0.0025
PREVIOUS_DAY_REJECTION_FAMILY_ID = "previous_day_rejection"
PREVIOUS_DAY_REJECTION_STRATEGY_VERSION = "fmp-previous-day-rejection-v1"
RESULT_PROTOCOL = "fmp-phase4-previous-day-rejection-grid-v1"
...
def run_previous_day_rejection_grid(
    *,
    dataset_root: Path,
    manifest_path: Path,
    symbol: str,
    ...
    for buffer_pips in PREVIOUS_DAY_REJECTION_GRID:
        strategy_config = PreviousDayRejectionConfig(
        ...
        for slippage_pips in SLIPPAGE_SCENARIOS:
            backtest_config = BacktestConfig(
                ...
                decision_config={
                    "family_id": PREVIOUS_DAY_REJECTION_FAMILY_ID,
                    "strategy_version": PREVIOUS_DAY_REJECTION_STRATEGY_VERSION,
                    "split_name": split_name,
                    "buffer_pips": buffer_pips,
