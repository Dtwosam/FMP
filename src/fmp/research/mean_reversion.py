...
MEAN_REVERSION_FAMILY_ID = "mean_reversion"
MEAN_REVERSION_STRATEGY_VERSION = "fmp-mean-reversion-v1"
RESULT_PROTOCOL = "fmp-phase4-mean-reversion-grid-v1"
...
def run_mean_reversion_grid(
    *,
    ...
    for lookback_hours, threshold_sigma in MEAN_REVERSION_GRID:
        strategy_config = MeanReversionConfig(
            lookback_hours=lookback_hours,
            threshold_sigma=threshold_sigma,
            timeframe=timeframe,
        )
        candidates = generate_mean_reversion_candidates(
            loaded.bars,
        ...
        for slippage_pips in SLIPPAGE_SCENARIOS:
            backtest_config = BacktestConfig(
                ...
                decision_config={
                    "family_id": MEAN_REVERSION_FAMILY_ID,
