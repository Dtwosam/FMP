...
def run_trend_continuation_grid(
    *,
    ...
    for trend_window_id, target_r_multiple in TREND_CONTINUATION_GRID:
        strategy_config = TrendContinuationConfig(
            trend_window_id=trend_window_id,
            target_r_multiple=target_r_multiple,
            timeframe=timeframe,
        )
        candidates = generate_trend_continuation_candidates(
            loaded.bars,
        ...
        for slippage_pips in SLIPPAGE_SCENARIOS:
            backtest_config = BacktestConfig(
                ...
                decision_config={
                    "family_id": TREND_CONTINUATION_FAMILY_ID,
                    "strategy_version": TREND_CONTINUATION_STRATEGY_VERSION,
                    "split_name": split_name,
                    "trend_window_id": trend_window_id,
                    "target_r_multiple": target_r_multiple,
