...
VOLATILITY_BREAKOUT_GRID = (1.0, 1.5, 2.0)
SLIPPAGE_SCENARIOS = (0.2, 0.5, 1.0)
STARTING_EQUITY_USD = 100_000.0
REQUESTED_RISK_FRACTION = 0.0025
VOLATILITY_BREAKOUT_FAMILY_ID = "volatility_breakout"
VOLATILITY_BREAKOUT_STRATEGY_VERSION = "fmp-volatility-breakout-v1"
RESULT_PROTOCOL = "fmp-phase4-volatility-breakout-grid-v1"
...
def run_volatility_breakout_grid(
    *,
    dataset_root: Path,
    manifest_path: Path,
    symbol: str,
    ...
    for range_multiplier in VOLATILITY_BREAKOUT_GRID:
        strategy_config = VolatilityBreakoutConfig(
            range_multiplier=range_multiplier,
            timeframe=timeframe,
        )
        candidates = generate_volatility_breakout_candidates(
            loaded.bars,
        ...
        for slippage_pips in SLIPPAGE_SCENARIOS:
            backtest_config = BacktestConfig(
                ...
                decision_config={
                    "family_id": VOLATILITY_BREAKOUT_FAMILY_ID,
                    "strategy_version": VOLATILITY_BREAKOUT_STRATEGY_VERSION,
                    "split_name": split_name,
                    "range_multiplier": range_multiplier,
