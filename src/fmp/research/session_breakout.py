...
SESSION_BREAKOUT_FAMILY_ID = "session_breakout"
SESSION_BREAKOUT_STRATEGY_VERSION = "fmp-session-breakout-v1"
RESULT_PROTOCOL = "fmp-phase4-session-breakout-grid-v1"
...
def run_session_breakout_grid(
    *,
    ...
    # Fail the final-test lock before any manifest or Parquet read.
    ...
    for buffer_pips, target_range_multiple in SESSION_BREAKOUT_GRID:
        strategy_config = SessionBreakoutConfig(
        ...
        for slippage_pips in SLIPPAGE_SCENARIOS:
            backtest_config = BacktestConfig(
                ...
                decision_config={
                    "family_id": SESSION_BREAKOUT_FAMILY_ID,
                    "strategy_version": SESSION_BREAKOUT_STRATEGY_VERSION,
                    "split_name": split_name,
                    "buffer_pips": buffer_pips,
                    "target_range_multiple": target_range_multiple,
