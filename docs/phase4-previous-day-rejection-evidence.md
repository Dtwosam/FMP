...
The previously promoted **USDJPY 15m session-breakout, 5-pip buffer, 1.5x target-range multiple** candidate remains frozen unchanged. Phase 4 remains ACTIVE. The next family in the original baseline-first queue is **volatility breakout**; the distinct session high/low sweep/rejection family remains sixth. The final test, Phase 5, broker/live integration, and real-money trading remain locked.
