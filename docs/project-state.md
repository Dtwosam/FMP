...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050 CLOSED/REVIEWED; EXP-051 DEC-150/151/152/153/154/155/156/157/158 CHAIN + ONE-WAY OPERATOR + REPAIRED READ-ONLY PLAN RUNNER FROZEN; ONE GUARDED HISTORICAL RUN AUTHORIZED, NOT DISPATCHED
**Next milestone:** Merge DEC-158 and inspect the repaired automatic DEC-156 read-only plan. Only if it proves MISSING/RUN_DISPATCH_REQUIRED may a separate executor be frozen to invoke the existing DEC-156 advance --execute path without embedding an independent model-workflow dispatch. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
