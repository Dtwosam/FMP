...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051 CLOSED/REVIEWED; EXP-052 DEC-163/164/165/166/167/168 CHAIN FROZEN; ONE GUARDED HISTORICAL RUN SOURCE-AUTHORIZED, NOT DISPATCHED
**Next milestone:** Freeze a clean-main, double-plan, one-way EXP-052 operator that exposes exactly one dispatch only while no run exists and routes terminal evidence through DEC-167. DEC-168 itself has not dispatched the workflow. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
