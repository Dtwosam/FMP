...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050 CLOSED/REVIEWED; EXP-051 DEC-150/DEC-151/DEC-152 SOURCE-ONLY PROTOCOL + CORE + ARTIFACT CONTRACT FROZEN
**Next milestone:** Freeze a source-only manual-main EXP-051 workflow, public CLI, pinned numerical runtime, and exact-source execution gate against DEC-150/151/152 while keeping dispatch, authoritative result execution, model fit, promotion, and all trading paths closed.
