...
2. no EXP-015, DEC-042, DEC-045, DEC-046, DEC-047, DEC-048, or DEC-049 result/campaign workflow has been dispatched; no Phase 8B live-shadow segment exists;
...
4. DEC-048 / EXP-20260922-019 campaign-start authorization is merged to `main` at `0cedfe61203601faa29f638459fb237e3c7740f1`; it freezes the UTC/London prospective boundary and `TAIL_AT_EOF_NO_BACKFILL` semantics but starts no segment;
5. PR #140 merged DEC-049 / EXP-20260922-020 source-free capture foundation to `main` at `39066f10c60bd1bade4f6f6e78e05ab3b7621c8e`: exact DEC-047/048 cross-binding, fresh EOF-tail session revalidation, deterministic capture-preflight artifacts, and deterministic TICK/HEARTBEAT record envelopes; the exact final PR head passed 961 tests plus workflow YAML and compile in run `35745448870`, and unchanged Phase 3 acceptance run `35745448859` passed;
6. PR #141 merged DEC-050 / `EXP-20260922-021` runtime/replay kernel to `main` at `4a8431d17f3fd050839d7841fc27e5543b258dc4`: complete-bar derivation, immutable strategy reconstruction, existing strategy/router reuse, shared Phase 3 virtual risk across symbols, deterministic segment evidence, and byte-identical replay; exact final PR-head tests passed 966 tests plus workflow YAML and compile, and unchanged Phase 3 acceptance passed;
7. PR #143 merged DEC-051 / `EXP-20260922-022` acceptance compiler to `main` at `2c9577be8eafb9e307e05214609206dfeb7c6c69`: exact prospective campaign/spread-reference schemas, immutable-fingerprint-first validation, frozen minimum/operational/spread/financial gates, deterministic outcome precedence, and PASS-only SHADOW_CANDIDATE -> SHADOW_VALIDATED authorization. The superseded PR #142 was closed unmerged after a stale-head synchronization issue; exact final PR #143 head `7ff2c482bfaf34902ac461eb448878b12e93ea54` passed 973 tests plus YAML/compile and unchanged Phase 3 acceptance. No live capture command exists; a later capture/close protocol must create real prospective evidence. All order/broker/real-money/Phase-9 execution paths remain locked.
8. DEC-052 / `EXP-20260922-023` campaign-close implementation is temporarily BLOCKED by the cross-segment virtual-state reset discovered before implementation; its prospective receipt/close contract remains frozen.
9. DEC-053 / `EXP-20260922-024` is the active source-free milestone: add exact multi-scenario runtime checkpoints so equity, daily-halt state, pending decisions, open positions, and terminal decision identities continue deterministically across finite DEC-050 segments. No live capture/order path is added. After DEC-053 merges, DEC-052 implementation may resume.
