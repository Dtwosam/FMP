...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046 CLOSED/REVIEWED + EXP-047 DEC-113 PROTOCOL MERGED + DEC-114 HGB DENSITY TRAINING CORE FROZEN; NO EXP-047 RESULT
**Next milestone:** Merge DEC-114's source-only EXP-047 HGB candidate-density training core, then freeze a separate artifact-backed runner/evidence contract around merged DEC-113/DEC-114 before any workflow or result-producing authorization is considered. Logistic remains excluded. No EXP-047 authoritative model fit, historical result execution, workflow, or run is authorized. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
