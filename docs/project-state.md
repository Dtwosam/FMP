...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051/EXP-052 CLOSED/REVIEWED; EXP-053 DEC-174/175/176/177/178/179/180/181 CHAIN + READ-ONLY PLAN RUNNER FROZEN; ONE GUARDED HISTORICAL RUN AUTHORIZED, NOT DISPATCHED
**Next milestone:** Merge DEC-181 and inspect its automatic read-only EXP-053 operator-plan run. Only an exact DEC-180 MISSING/RUN_DISPATCH_REQUIRED plan may open a later one-shot executor; DEC-181 itself cannot dispatch. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
