...
7. DEC-051 / `EXP-20260922-022` is the active source-free milestone: freeze and implement the deterministic Phase 8B acceptance compiler plus the exact future `fmp-phase8b-campaign-evidence-v1` and spread-reference contracts. No live capture command exists; a later capture/close protocol must create prospective evidence before review. Demo/live orders, broker mutation, real-money trading, Phase 9 execution, active-champion hot swap, and acceptance remain locked.
