...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051/EXP-052 CLOSED/REVIEWED; EXP-053 DEC-174/175 SOURCE-ONLY PROTOCOL + IN-MEMORY CORE FROZEN; NO EXP-053 HISTORICAL FIT
**Next milestone:** Freeze the EXP-053 artifact/evidence contract against DEC-174/175. It must validate complete 18-cell / 108-regressor / 108-pooled-reference / 432-utility-support-reference / 216-feature-support-reference evidence and the four-part cutoff while remaining non-executable before readiness/artifact loading. Promotion and trading remain locked.
