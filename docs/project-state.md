...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051 CLOSED/REVIEWED; EXP-052 DEC-163/164/165/166/167/168/169/170/171 CHAIN + ONE-SHOT EXECUTOR SOURCE FROZEN; ONE GUARDED HISTORICAL RUN AUTHORIZED, NOT YET DISPATCHED
**Next milestone:** Merge DEC-171 after green regressions. Its automatic push run may invoke only DEC-169 advance --execute; if that submits EXP-052, the resulting manual-main workflow becomes the consumed DEC-168 attempt 1 and must be observed to terminal state and reviewed through DEC-167 with no rerun. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
