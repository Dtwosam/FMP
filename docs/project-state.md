...
6. DEC-050 / `EXP-20260922-021` runtime/replay kernel is implemented on PR #141 head `744f4b91a68cb91fca820ca5b5cbd2e35ae966b4`: complete-bar derivation, immutable strategy reconstruction, existing strategy/router reuse, shared Phase 3 virtual risk across symbols, deterministic segment evidence, and byte-identical replay; PR CI `35747895559` passed 966 tests plus workflow YAML and compile, and unchanged Phase 3 acceptance `35747895632` passed;
7. final Phase 8B acceptance remains a separate later decision. No live capture command exists. Legacy 8-week / 30-date / 40-trade, coverage, timing, spread-parity, profitability, drawdown, replay, and safety gates remain frozen; demo/live orders, broker mutation, real-money trading, Phase 9, active-champion mutation, acceptance, and promotion remain locked.
