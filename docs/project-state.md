...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047 CLOSED/REVIEWED + EXP-048 DEC-123 PROTOCOL + DEC-124 CORE + DEC-125 ARTIFACT CONTRACT FROZEN; NO EXP-048 FIT OR RESULT
**Next milestone:** Merge DEC-125's source-only EXP-048 artifact/evidence contract, then freeze a manual-main input-free workflow, model CLI, pinned runtime, and exact-source execution gate around merged DEC-123/DEC-124/DEC-125. No EXP-048 workflow dispatch, model fit, or historical result execution is authorized. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
