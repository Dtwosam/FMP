...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051/EXP-052 CLOSED/REVIEWED; EXP-053 DEC-174/175/176/177/178/179/180/181/182 CHAIN + ONE-SHOT EXECUTOR SOURCE FROZEN; ONE GUARDED HISTORICAL RUN AUTHORIZED, NOT YET DISPATCHED
**Next milestone:** Merge DEC-182 only after green repository checks. Its path-scoped executor may then invoke the exact DEC-180 advance --execute path once. Any resulting manual-main EXP-053 run consumes the DEC-179 slot and must be observed to terminal state and reviewed through DEC-178 without rerun. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
