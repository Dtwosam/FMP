...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047 CLOSED/REVIEWED + EXP-048 DEC-123 REGIME-CONSENSUS PROTOCOL + DEC-124 TRAINING CORE FROZEN; NO EXP-048 FIT OR RESULT
**Next milestone:** Merge DEC-124's source-only EXP-048 deterministic regime-consensus training core, then freeze a separate artifact-backed runner/evidence contract around merged DEC-123/DEC-124. No authoritative EXP-048 data loading, model fit, historical result execution, workflow, or run is authorized. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
