...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048 CLOSED/REVIEWED + EXP-049 DEC-137 ONE-RUN AUTHORIZATION SOURCE FROZEN; NO EXP-049 RESULT
**Next milestone:** Merge DEC-137's single guarded EXP-049 historical run authorization. DEC-137 itself dispatches nothing. After merge, freeze a clean-main one-way operator that exposes exactly one dispatch only while no EXP-049 run exists and routes terminal evidence through DEC-136. The first manual-main attempt will consume the slot on any terminal outcome; no automatic retry/replacement. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
