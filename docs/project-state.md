...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051 CLOSED/REVIEWED; EXP-052 DEC-163/164/165 SOURCE-ONLY PROTOCOL + TRAINING CORE + ARTIFACT CONTRACT FROZEN
**Next milestone:** Freeze a manual-main, input-free EXP-052 workflow, public CLI, pinned numerical runtime, and exact-source execution gate against DEC-163/164/165 while keeping dispatch, authoritative result execution, and model fit false.
