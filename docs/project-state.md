...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051 CLOSED/REVIEWED; EXP-052 DEC-163 SOURCE-ONLY FIT-TEMPORAL-SUPPORT PROTOCOL FROZEN
**Next milestone:** Implement the deterministic in-memory EXP-052 training/evaluation core against the exact DEC-163 protocol, including 24 fit-half-year out-of-fit support references and support-first ranking. No authoritative artifact loading, historical result execution, workflow dispatch, promotion, or trading authority is opened.
