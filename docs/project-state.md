...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050 CLOSED/REVIEWED; EXP-051 DEC-150/151/152/153/154/155/156/157/158/159/160 CHAIN + ONE-WAY OPERATOR + VERIFIED PLAN + ONE-SHOT EXECUTOR FROZEN; ONE GUARDED HISTORICAL RUN AUTHORIZED, NOT YET DISPATCHED
**Next milestone:** Merge DEC-160. Its automatic executor may invoke only the existing DEC-156 advance --execute path. If DEC-156 submits the EXP-051 model workflow, treat that run as the consumed attempt 1, observe it to terminal state, and route all terminal evidence through DEC-154 with no rerun. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
