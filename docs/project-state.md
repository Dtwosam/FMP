...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051 CLOSED/REVIEWED; EXP-052 DEC-163/164 SOURCE-ONLY PROTOCOL + TRAINING CORE FROZEN
**Next milestone:** Freeze an artifact-backed EXP-052 runner/evidence contract against the exact DEC-163 protocol and DEC-164 training-core blobs, validating 18 cells / 108 regressors / 108 pooled references / 432 support references while keeping authoritative historical execution closed.
