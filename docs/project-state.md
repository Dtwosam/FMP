...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051/EXP-052 CLOSED/REVIEWED; EXP-053 DEC-174 SOURCE-ONLY PROTOCOL FROZEN; NO EXP-053 FIT
**Next milestone:** Implement a deterministic in-memory EXP-053 training/evaluation core against the exact DEC-174 protocol. It may build 12 fit-temporal feature-support references and the four-part cutoff in memory only; accepted historical artifact loading, authoritative fit/result execution, promotion, and trading remain locked.
