...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049 CLOSED/REVIEWED; EXP-050 DEC-142 TRAINING CORE SOURCE FROZEN
**Next milestone:** Freeze the EXP-050 artifact-backed runner/evidence contract against the exact DEC-142 training-core blob. Keep authoritative model fit/result execution closed until later workflow, terminal-review, and one-run authorization decisions. Promotion and all trading paths remain locked.
