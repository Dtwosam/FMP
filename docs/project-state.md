...
8. DEC-052 / `EXP-20260922-023` is the active source-free milestone: implement the validator-only prospective receipt contract and deterministic campaign-close assembler required to create DEC-051 campaign evidence from future replay-verified live segments. It adds no live capture command and cannot manufacture prospective receipts; a later live-tail protocol remains mandatory. All order/broker/real-money/Phase-9 paths remain locked.
