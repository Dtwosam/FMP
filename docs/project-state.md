...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050 CLOSED/REVIEWED; DEC-149 EXP-050 POST-RESULT DIAGNOSTIC FROZEN
**Next milestone:** Freeze a separate successor protocol source against the DEC-149 diagnostic before any new historical fitting or result execution. EXP-050 remains closed to rerun/replacement. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
