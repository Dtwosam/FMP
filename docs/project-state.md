...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051 CLOSED/REVIEWED; EXP-052 DEC-163/164/165/166/167/168/169/170 CHAIN + ONE-WAY OPERATOR + READ-ONLY PLAN RUNNER FROZEN; ONE GUARDED HISTORICAL RUN AUTHORIZED, NOT DISPATCHED
**Next milestone:** Merge DEC-170, require its automatic read-only plan run to prove the exact DEC-169 MISSING / RUN_DISPATCH_REQUIRED state, and only then freeze any environment-specific one-shot executor around DEC-169 advance --execute. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
