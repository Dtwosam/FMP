...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049 CLOSED/REVIEWED; EXP-050 DEC-143 ARTIFACT/EVIDENCE CONTRACT SOURCE FROZEN
**Next milestone:** Freeze a manual-main, input-free EXP-050 workflow/CLI, pinned numerical runtime, and exact-source execution gate against DEC-143 while keeping dispatch/result/fit authorization closed. Terminal review and one-run authorization must remain separate later decisions. Promotion and all trading paths remain locked.
