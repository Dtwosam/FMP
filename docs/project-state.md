...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050 CLOSED/REVIEWED; EXP-051 DEC-150 SOURCE-ONLY PROTOCOL FROZEN
**Next milestone:** Implement the deterministic in-memory EXP-051 training/evaluation core against the exact DEC-150 protocol source. No authoritative artifact loading, model-result execution, workflow dispatch, promotion, shadow/demo execution, broker mutation, live orders, real-money trading, or trading authorization is opened.
