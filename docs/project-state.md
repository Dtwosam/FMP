...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050 CLOSED/REVIEWED; EXP-051 DEC-150/DEC-151 SOURCE-ONLY PROTOCOL + TRAINING CORE FROZEN
**Next milestone:** Freeze an artifact-backed EXP-051 runner/evidence contract against the exact DEC-150 protocol and DEC-151 training-core blobs while keeping authoritative historical result execution closed. Promotion, shadow/demo execution, broker mutation, live orders, real-money trading, and trading authorization remain locked.
