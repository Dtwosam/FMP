...
**Phase status:** ACTIVE — EXP-044 V1 CLOSED + EXP-045/EXP-046/EXP-047/EXP-048/EXP-049/EXP-050/EXP-051/EXP-052 CLOSED/REVIEWED; EXP-053 DEC-174/175/176 SOURCE-ONLY PROTOCOL + CORE + ARTIFACT CONTRACT FROZEN; NO EXP-053 HISTORICAL FIT
**Next milestone:** Freeze the manual-main, input-free EXP-053 workflow, public CLI, pinned numerical runtime, and exact-source execution gate while keeping dispatch/result/fit authorization false. Terminal review and any one-run authorization must remain separate later decisions.
