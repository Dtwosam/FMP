...
The operator core is `src/fmp/market_learning/model_successor_fit_temporal_feature_support_utility_operator.py` at Git blob `47455c4be8cae5e65c2157000c05f514d551ad32`. The public CLI is `scripts/phase8a_exp053_operator.py` at blob `04bad97e1c9b215b7ac8b699ddc2cb6c329331b3`. Focused tests are `tests/test_phase8a_exp053_operator.py` at blob `2907368efe9caecdc07ed38ee1dab0d36e96f58c`. The detailed operator spec is `docs/superpowers/specs/2026-09-25-phase8a-exp053-single-step-operator.md` at blob `b36f1cf2a1b036ad64b0aef871bf84c2b154ce3d`.
