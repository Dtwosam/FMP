...
The result-decision source is `src/fmp/market_learning/model_successor_regime_utility_result_decision.py`; focused tests are `tests/test_phase8a_exp049_model_result_decision.py`; the reviewed-result record is `docs/superpowers/specs/2026-09-24-phase8a-exp049-reviewed-model-result.md`.
