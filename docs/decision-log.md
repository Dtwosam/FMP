...
Focused tests are `tests/test_phase8a_exp053_model_workflow.py` at blob `f7737e966592a1ae1c356d3e44b89df815fc7348`. The detailed authorization spec is `docs/superpowers/specs/2026-09-25-phase8a-exp053-single-model-run-authorization.md` at blob `ee11afda5bfd9c777070e1c50e674796a6bc2abc`.
