...
- DEC-083 merge: PR #187 merged to `main` at `95e7fa968f6b93fa2a2bba1b8669c33b8b4e5e30`. Exact PR head `a25af6753dc7da019cb0158a654b8eb87cc3d006` passed 1169 tests plus workflow-YAML validation and compile in run `35856794722`; unchanged Phase 3 acceptance run `35856794885` passed. Post-merge `main` tests run `35856997459` and Phase 3 acceptance run `35856997424` also passed. No EXP-044 feature or outcome workflow had been dispatched at merge time.
