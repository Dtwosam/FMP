...
from fmp.research.previous_day_rejection import run_previous_day_rejection_grid
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the frozen Phase 4 previous-day rejection research benchmark.",
    )
