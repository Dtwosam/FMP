...
from fmp.research.volatility_breakout import run_volatility_breakout_grid
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the frozen Phase 4 rolling volatility-breakout research benchmark.",
    )
