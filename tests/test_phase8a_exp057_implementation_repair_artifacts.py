...
class Exp057RepairArtifactContractTests(unittest.TestCase):
    ...
    def test_repair_provenance_drift_fails_closed(self) -> None:
        cells = [
            _cell(
                cell.symbol,
                cell.timeframe,
        ...
        cells[0]["dec220_protocol_blob_sha"] = "0" * 40
        supplied = dict(cells[0])
        supplied.pop("result_fingerprint")
        cells[0]["result_fingerprint"] = hashlib.sha256(
            _canonical_json(supplied)
