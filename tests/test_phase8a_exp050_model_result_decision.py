...
from fmp.market_learning.model_successor_temporal_jackknife_utility_result_decision import (
...
class Exp050ResultDecisionTests(unittest.TestCase):
    @patch(
        "fmp.market_learning."
        "model_successor_temporal_jackknife_utility_result_decision."
    ...
    def test_exact_review_closes_without_stable_candidate(
        ...
        self.assertEqual(
            report["temporal_jackknife_utility_model_result_decision"],
            TEMPORAL_JACKKNIFE_UTILITY_MODEL_RESULT_DECISION,
        )
        self.assertEqual(
            report["stage"],
