...
from fmp.market_learning.model_successor_density_result_decision import (
...
def _terminal_review() -> dict[str, object]:
    return {
        ...
        "no_density_stable_model_challenger_count": 18,
...
class Exp047ResultDecisionTests(unittest.TestCase):
    @patch(
        "fmp.market_learning."
        "model_successor_density_result_decision."
    ...
    def test_exact_review_closes_without_stable_candidate(
        ...
        report = validate_reviewed_density_model_result(
            run=_run(),
            jobs_payload={"jobs": []},
        ...
        self.assertEqual(
            report["density_model_result_decision"],
            DENSITY_MODEL_RESULT_DECISION,
        )
        self.assertEqual(
            report["stage"],
        ...
        self.assertEqual(
            report["no_density_stable_model_challenger_count"],
            18,
        )
        self.assertEqual(
