...
from fmp.market_learning.model_successor_fit_temporal_residual_regime_balance_utility_repair_result_decision import (
...
def _cell(
    ...
    row: dict[str, object] = {
        ...
        "fit": {
            ...
            "fit_temporal_residual_regime_balance_regime_count": 3,
            "fit_temporal_residual_regime_balance_source_bound_count_per_row": 12,
...
class Exp060ResultDecisionTests(unittest.TestCase):
    @patch(
        "fmp.market_learning."
        "model_successor_fit_temporal_residual_regime_balance_utility_repair_result_decision."
    ...
    def test_exact_review_closes_without_stable_candidate(
        ...
        self.assertEqual(
            report["verified_fit_temporal_residual_regime_count"],
            REVIEWED_VERIFIED_RESIDUAL_REGIME_COUNT,
        )
        self.assertEqual(
            report["verified_fit_temporal_residual_windows_per_regime"],
            REVIEWED_VERIFIED_RESIDUAL_WINDOWS_PER_REGIME,
        )
        self.assertEqual(
            report[
