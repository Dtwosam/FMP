...
from fmp.market_learning.model_successor_fit_temporal_residual_breadth_utility_result_decision import (
...
class Exp055ResultDecisionTests(unittest.TestCase):
    @patch(
        "fmp.market_learning."
        "model_successor_fit_temporal_residual_breadth_utility_result_decision."
    ...
    def test_window_inventory_drift_fails_closed(
        ...
        variant = next(
            ...
            if value["candidate_budget_anchor"] == 250
        )
        variant["temporal_stability"]["windows"][3]["metrics"][
